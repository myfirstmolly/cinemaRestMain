...
public class RestTest {
    ...
    public void testClient() {
        ...
        //add halls
        Hall small = new Hall("Small Hall 2", 5, 5);
        Hall medium = new Hall("Medium Hall 2", 6, 15);
        Hall big = new Hall("Big Hall 2", 10, 20);
        ...
        Film strangersFromHell = new Film("Strangers from Hell2", "Lee Chang-Hee",
